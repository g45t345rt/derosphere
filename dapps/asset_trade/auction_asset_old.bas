...
200 storeStateInt(auKey(auId, "close"), 0)
210 endCommit()
...
60 beginCommit()
70 storeStateInt(auKey(auId, "close"), 1)
80 endCommit()
90 RETURN 0
End Function
...
110 IF loadStateInt(auKey(auId, "close")) == 0 THEN GOTO 130
120 RETURN 1
...
180 beginCommit()
190 storeStateInt(auKey(auId, "close"), 1)
...
80 LET winner = loadStateString(auKey(auId, "lastBidder"))
90 IF loadStateInt(auKey(auId, "close")) == 1 THEN GOTO 110
100 RETURN 1
